...
(function (factory, window) {
  ...
  L.Editable = L.Evented.extend({
    ...
    createLineGuide: function () {
      var options = L.extend(
        { dashArray: "5,10", color: "#00d9e9", weight: 1, interactive: false },
    ...
    createPolyline: function (latlngs, options) {
      return this.createLayer(
        (options && options.polylineClass) || this.options.polylineClass,
        latlngs,
        options
      );
    },
    ...
    createPolygon: function (latlngs, options) {
      return this.createLayer(
        (options && options.polygonClass) || this.options.polygonClass,
        latlngs,
        options
      );
    },
    ...
    createMarker: function (latlng, options) {
      return this.createLayer(
        (options && options.markerClass) || this.options.markerClass,
        latlng,
        options
      );
    },
    ...
    createRectangle: function (bounds, options) {
      return this.createLayer(
        (options && options.rectangleClass) || this.options.rectangleClass,
        bounds,
        options
      );
    },
    ...
    createCircle: function (latlng, options) {
      return this.createLayer(
        (options && options.circleClass) || this.options.circleClass,
        latlng,
        options
      );
    },
  ...
  L.Map.addInitHook(function () {
    this.whenReady(function () {
      if (this.options.editable) {
        this.editTools = new this.options.editToolsClass(
          this,
  ...
  L.Editable.BaseEditor = L.Handler.extend({
    ...
    hasMiddleMarkers: function () {
      return (
        !this.options.skipMiddleMarkers && !this.tools.options.skipMiddleMarkers
      );
    },
  ...
  L.Editable.PathEditor = L.Editable.BaseEditor.extend({
    ...
    addMiddleMarker: function (left, right, latlngs) {
      return new this.tools.options.middleMarkerClass(
        left,
        right,
        latlngs,
        this
  ...
  L.Editable.PolygonEditor = L.Editable.PathEditor.extend({
    ...
    vertexCanBeDeleted: function (vertex) {
      ...
      return L.Editable.PathEditor.prototype.vertexCanBeDeleted.call(
        this,
        vertex
      );
    },
  ...
  L.Editable.CircleEditor = L.Editable.PathEditor.extend({
    ...
    initialize: function (map, feature, options) {
      L.Editable.PathEditor.prototype.initialize.call(
        this,
        map,
        feature,
        options
  ...
  var PolylineMixin = {
    getEditorClass: function (tools) {
      return tools && tools.options.polylineEditorClass
        ? tools.options.polylineEditorClass
  ...
  var PolygonMixin = {
    getEditorClass: function (tools) {
      return tools && tools.options.polygonEditorClass
        ? tools.options.polygonEditorClass
    ...
    isInLatLngs: function (l, latlngs) {
      ...
      for (j = 0, len2 = latlngs.length, k = len2 - 1; j < len2; k = j++) {
        ...
        if (
          ...
          l.lng <
            ((l2.lng - l1.lng) * (l.lat - l1.lat)) / (l2.lat - l1.lat) + l1.lng
        ) {
          inside = !inside;
        }
      }
  ...
  var RectangleMixin = {
    getEditorClass: function (tools) {
      return tools && tools.options.rectangleEditorClass
        ? tools.options.rectangleEditorClass
  ...
  var CircleMixin = {
    getEditorClass: function (tools) {
      return tools && tools.options.circleEditorClass
        ? tools.options.circleEditorClass
